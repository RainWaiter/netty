...
public final class EpollDatagramChannelConfig extends EpollChannelConfig implements DatagramChannelConfig {
    ...
    public Map<ChannelOption<?>, Object> getOptions() {
        return getOptions(
                ...
                EpollChannelOption.IP_RECVORIGDSTADDR, EpollChannelOption.MAX_DATAGRAM_SIZE);
    }
    ...
    public <T> T getOption(ChannelOption<T> option) {
        ...
        if (option == EpollChannelOption.MAX_DATAGRAM_SIZE) {
            return (T) Integer.valueOf(getMaxDatagramPacketSize());
        }
    ...
    public <T> boolean setOption(ChannelOption<T> option, T value) {
        ...
        } else if (option == EpollChannelOption.MAX_DATAGRAM_SIZE) {
            setMaxDatagramPacketSize((Integer) value);
        } else {
     ...
     * will enable it.
     */
    public EpollDatagramChannelConfig setMaxDatagramPacketSize(int maxDatagramSize) {
     ...
     */
    public int getMaxDatagramPacketSize() {
